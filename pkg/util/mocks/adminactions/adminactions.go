...
// Source: github.com/Azure/ARO-RP/pkg/frontend/adminactions (interfaces: KubeActions,DrainActions,AzureActions)
...
// MockDrainActions is a mock of DrainActions interface.
type MockDrainActions struct {
	ctrl     *gomock.Controller
	recorder *MockDrainActionsMockRecorder
}

// MockDrainActionsMockRecorder is the mock recorder for MockDrainActions.
type MockDrainActionsMockRecorder struct {
	mock *MockDrainActions
}

// NewMockDrainActions creates a new mock instance.
func NewMockDrainActions(ctrl *gomock.Controller) *MockDrainActions {
	mock := &MockDrainActions{ctrl: ctrl}
	mock.recorder = &MockDrainActionsMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockDrainActions) EXPECT() *MockDrainActionsMockRecorder {
	return m.recorder
}
